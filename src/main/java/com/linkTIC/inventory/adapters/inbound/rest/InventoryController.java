...
public class InventoryController {
    ...
    @Operation(summary = "Get inventory by ID", description = "Returns a single inventory")
    public ResponseEntity<InventoryDTO> getProductId(@PathVariable Long id){   	
        return ResponseEntity.ok(InventoryMapper.toDto(inventoryService.findByProductoId(id)));
    }
